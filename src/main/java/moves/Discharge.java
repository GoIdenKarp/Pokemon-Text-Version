...
public class Discharge extends Move {
    ...
    public static final String DESCRIPTION = "The user strikes everything around it by letting loose a flare of electricity. This may also cause paralysis.";


    private static final Type TYPE = Type.ELECTRIC;
    private static final Effect EFFECT = Effect.PARATHIRTY;
