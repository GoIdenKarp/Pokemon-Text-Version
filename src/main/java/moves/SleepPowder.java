...
public class SleepPowder extends Move {
    ...
    private static final String NAME = "Sleep Powder";
    ...
    private static final String DESCRIPTION = "The user scatters a big cloud of sleep-inducing dust around the target.";


    private static final Type TYPE = Type.GRASS;
    private static final Effect EFFECT = Effect.SLEEP;
