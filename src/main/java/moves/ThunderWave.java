...
public class ThunderWave extends Move {
    ...
    private static final String DESCRIPTION = "The user launches a weak jolt of electricity that paralyzes the target.";
