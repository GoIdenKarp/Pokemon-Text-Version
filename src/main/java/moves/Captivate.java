...
public class Captivate extends Move {
    ...
    private static final String NAME = "Captivate";
    ...
    private static final String DESCRIPTION = "If it is the opposite gender of the user, " +
            "the foe is charmed into sharply lowering its Sp. Atk stat.";


    private static final Type TYPE = Type.NORMAL;
    private static final Effect EFFECT = Effect.CAPTIVATE;
