...
public class KarateChop extends Move {
    ...
    private static final String NAME = "Karate Chop";
    ...
    private static final String DESCRIPTION = "The target is attacked with a sharp chop. Critical hits land more easily.\n";
