...
public class FeatherDance extends Move {
    ...
    private static final String DESCRIPTION = "The foe is covered with a mass of down that sharply cuts the Attack stat.";


    private static final Type TYPE = Type.FLYING;
    private static final Effect EFFECT = Effect.TARGET_ATK_DOWN_SHARP;
