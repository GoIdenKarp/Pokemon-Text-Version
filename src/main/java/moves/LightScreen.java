...
public class LightScreen extends Move {
    ...
    private static final String NAME = "Light Screen";
    ...
    private static final String DESCRIPTION = "A wondrous wall of light is put up to reduce damage from special attacks for five turns.";


    private static final Type TYPE = Type.PSYCHIC;
    private static final Effect EFFECT = Effect.LIGHT_SCREEN;
