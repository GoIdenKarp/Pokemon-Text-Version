...
public class Glare extends Move {
    ...
    private static final String DESCRIPTION = "The user intimidates the target with the pattern on its belly to cause paralysis.";
