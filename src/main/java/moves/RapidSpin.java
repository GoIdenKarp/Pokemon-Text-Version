...
public class RapidSpin extends Move {
    ...
    private static final String NAME = "Rapid Spin";
    ...
    private static final String DESCRIPTION = "A spin attack that can also eliminate such moves as Bind, Wrap, " +
            "Leech Seed, and Spikes.";


    private static final Type TYPE = Type.NORMAL;
    private static final Effect EFFECT = Effect.REMOVE_HAZARDS;
