...
public class FlareBlitz extends Move{
    ...
    private static final String DESCRIPTION = "The user cloaks itself in fire and charges the target. " +
            "This also damages the user quite a lot. This may leave the target with a burn.";


    private static final Type TYPE = Type.FIRE;
    private static final Effect EFFECT = Effect.BURN_THIRD_RECOIL;
