...
public class PoisonSting extends Move {
    ...
    private static final String NAME = "Poison Sting";
    private static final int STARTING_MAX_PP = 35;
    private static final int FINAL_MAX_PP = 56;
    private static final Boolean MAKES_CONTACT = false;
    private static final String DESCRIPTION = "The foe is stabbed with a toxic barb, etc. It may poison the foe.";


    private static final Type TYPE = Type.POISON;
    private static final Effect EFFECT = Effect.POISON_THIRTY;
