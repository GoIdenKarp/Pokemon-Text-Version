...
public class SandAttack extends Move {
    ...
    private static final String NAME = "Sand Attack";
    ...
    private static final String DESCRIPTION = "A lot of sand is hurled in the foe's face, reducing its accuracy."
    ;


    private static final Type TYPE = Type.GROUND;
    private static final Effect EFFECT = Effect.TARGET_ACC_DOWN;
