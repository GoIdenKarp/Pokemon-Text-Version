...
public class QuiverDance extends Move {
    ...
    private static final String DESCRIPTION = "The user lightly performs a beautiful, mystic dance. " +
            "This boosts the user's Sp. Atk, Sp. Def, and Speed stats.";


    private static final Type TYPE = Type.BUG;
    private static final Effect EFFECT = Effect.QUIVER_DANCE;
