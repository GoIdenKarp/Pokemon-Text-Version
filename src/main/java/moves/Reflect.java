...
public class Reflect extends Move {
    ...
    private static final String DESCRIPTION = "A wondrous wall of light is put up to reduce damage from physical attacks " +
            "for five turns.";


    private static final Type TYPE = Type.PSYCHIC;
    private static final Effect EFFECT = Effect.REFLECT;
