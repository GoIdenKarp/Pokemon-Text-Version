...
public class LeechSeed extends Move {
    ...
    private static final String NAME = "Leech Seed";
    ...
    private static final String DESCRIPTION = "A seed is planted on the target. It steals some HP from the target every turn.";


    private static final Type TYPE = Type.GRASS;
    private static final Effect EFFECT = Effect.LEECH_SEED;
