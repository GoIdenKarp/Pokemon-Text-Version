...
public class Agility extends Move {
    ...
    private static final String NAME = "Agility";
    private static final int STARTING_MAX_PP = 30;
    private static final int FINAL_MAX_PP = 48;
    private static final Boolean MAKES_CONTACT = false;
    private static final String DESCRIPTION = "The user relaxes and lightens its body to move faster. " +
            "This sharply raises the Speed stat.";


    private static final Type TYPE = Type.PSYCHIC;
    private static final Effect EFFECT = Effect.SELF_SPEED_UP_SHARP;
