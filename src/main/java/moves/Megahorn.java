...
public class Megahorn extends Move {
    ...
    private static final String NAME = "Megahorn";
    ...
    private static final String DESCRIPTION = "Using its tough and impressive horn, the user rams into the target with no letup.";
