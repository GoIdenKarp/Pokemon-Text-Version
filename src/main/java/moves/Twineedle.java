...
public class Twineedle extends MultiStrikeMove {
    ...
    private static final String DESCRIPTION = "The foe is stabbed twice with foreleg stingers. It may poison the foe.";


    private static final Type TYPE = Type.BUG;
    private static final Effect EFFECT = Effect.POISON_TWENTY;
    private static final Category CATEGORY = Category.PHYSICAL;
    private static final Target TARGET = Target.SINGLE_TARGET;

    private static final int NUMBER_OF_HITS = 2;
