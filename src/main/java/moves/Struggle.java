...
public class Struggle extends Move {
    ...
    private static final int STARTING_MAX_PP = 1;
    private static final int FINAL_MAX_PP = 1;
    private static final Boolean MAKES_CONTACT = true;
    private static final String DESCRIPTION = "An almost invisibly fast attack that is certain to strike first.";


    private static final Type TYPE = Type.TYPELESS;
    private static final Effect EFFECT = Effect.STRUGGLE;
    private static final Category CATEGORY = Category.PHYSICAL;
    private static final Target TARGET = Target.RANDOM_ENEMY;
