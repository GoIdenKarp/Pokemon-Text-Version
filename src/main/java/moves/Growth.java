...
public class Growth extends Move {
    ...
    private static final String DESCRIPTION = "The user's body grows all at once, raising the Attack and Sp. Atk stats.";


    private static final Type TYPE = Type.NORMAL;
    private static final Effect EFFECT = Effect.GROWTH;
