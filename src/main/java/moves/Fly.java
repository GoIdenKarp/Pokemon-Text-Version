...
public class Fly extends ChargeMove {

    private static final String CHARGE_MESSAGE = "%s flew up high!\n";
    //
    ...
    private static final String DESCRIPTION = "The user soars and then strikes its target on the next turn.";
    ...
    private static final Effect effectOne = Effect.FLY;
