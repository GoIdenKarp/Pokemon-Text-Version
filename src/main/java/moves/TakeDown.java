...
public class TakeDown extends Move {
    ...
    private static final String NAME = "Take Down";
    ...
    private static final String DESCRIPTION = "A reckless, full-body charge attack that also hurts the user a little.";
