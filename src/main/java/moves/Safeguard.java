...
public class Safeguard extends Move {
    ...
    private static final String NAME = "Safeguard";
    ...
    private static final String DESCRIPTION = "It protects the user's party from all status problems for five turns.";


    private static final Type TYPE = Type.NORMAL;
    private static final Effect EFFECT = Effect.SAFEGUARD;
