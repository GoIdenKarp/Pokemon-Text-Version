...
public class WillOWisp extends Move {
    ...
    private static final String NAME = "Will-O-Wisp";
    ...
    private static final String DESCRIPTION = "The user shoots a sinister, bluish-white flame at the target to inflict a burn.";


    private static final Type TYPE = Type.FIRE;
    private static final Effect EFFECT = Effect.BURN;
