...
public class FuryAttack extends MultiStrikeMove {
    ...
    private static final String DESCRIPTION = "The target is jabbed repeatedly with a horn or beak two to five times in a row.";
