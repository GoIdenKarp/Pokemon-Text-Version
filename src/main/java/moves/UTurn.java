...
public class UTurn extends Move {
    ...
    private static final String NAME = "U-Turn";
    ...
    private static final String DESCRIPTION = "After making its attack, the user rushes back to switch places with a " +
            "party Pokémon in waiting.";


    private static final Type TYPE = Type.BUG;
    private static final Effect EFFECT = Effect.SWITCH_USER;
