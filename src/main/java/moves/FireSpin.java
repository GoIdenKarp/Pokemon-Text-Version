...
public class FireSpin extends Move {
    ...
    private static final String DESCRIPTION = "The foe is trapped in an intense spiral of fire that rages two to five turns.";


    private static final Type TYPE = Type.FIRE;
    private static final Effect EFFECT = Effect.FIRE_SPIN;
