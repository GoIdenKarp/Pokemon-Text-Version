...
public class RazorLeaf extends Move {
    ...
    private static final String NAME = "Razor Leaf";
    ...
    private static final String DESCRIPTION = "The foe is hit with a cutting leaf. It has a high critical-hit ratio.";
