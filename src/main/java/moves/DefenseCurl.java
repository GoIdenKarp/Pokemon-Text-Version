...
public class DefenseCurl extends Move {
    ...
    private static final String NAME = "Defense Curl";
    ...
    private static final String DESCRIPTION = "The user curls up to conceal weak spots and raise its Defense stat.";


    private static final Type TYPE = Type.NORMAL;
    private static final Effect EFFECT = Effect.SELF_DEF_UP;
