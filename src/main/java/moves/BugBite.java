...
public class BugBite extends Move {
    ...
    private static final String DESCRIPTION = "The user bites the foe. If the foe is holding a Berry, the user eats it " +
            "and gains its effect.";


    private static final Type TYPE = Type.BUG;
    private static final Effect EFFECT = Effect.BUG_BITE;
