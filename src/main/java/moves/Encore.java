...
public class Encore extends Move {
    ...
    private static final String NAME = "Encore";
    ...
    private static final String DESCRIPTION = "The user compels the target to keep using the move it encored for three turns.";


    private static final Type TYPE = Type.NORMAL;
    private static final Effect EFFECT = Effect.ENCORE;
