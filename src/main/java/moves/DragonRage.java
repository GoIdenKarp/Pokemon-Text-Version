...
public class DragonRage extends Move{
    ...
    private static final String NAME = "Dragon Rage";
    ...
    private static final String DESCRIPTION = "The foe is hit with a shock wave that always inflicts 40 HP damage.";
