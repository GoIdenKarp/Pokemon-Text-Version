...
public class Roar extends Move {
    ...
    private static final String NAME = "Roar";
    ...
    private static final String DESCRIPTION = "The target is scared off, and a different Pokémon is dragged out. " +
            "In the wild, this ends a battle against a single Pokémon.";


    private static final Type TYPE = Type.NORMAL;
    private static final Effect EFFECT = Effect.FORCE_SWITCH;
