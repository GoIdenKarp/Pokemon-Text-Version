...
public class DoubleKick extends MultiStrikeMove {
    ...
    private static final String DESCRIPTION = "The target is quickly kicked twice in succession using both feet.";
