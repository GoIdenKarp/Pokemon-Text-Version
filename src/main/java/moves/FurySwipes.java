...
public class FurySwipes extends MultiStrikeMove {
    ...
    private static final String DESCRIPTION = "The target is raked with sharp claws or scythes quickly two to five times in a row.";
