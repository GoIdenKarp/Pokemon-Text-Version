...
public class FlameBurst extends Move {
    ...
    private static final String NAME = "Flame Burst";
    ...
    private static final String DESCRIPTION = "The user attacks the target with a bursting flame. " +
            "The bursting flame damages Pokémon next to the target as well.";
