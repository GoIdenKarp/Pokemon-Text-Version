...
public class PoisonPowder extends Move {
    ...
    private static final String NAME = "Poison Powder";
    ...
    private static final String DESCRIPTION = "The user scatters a cloud of poisonous dust that poisons the target.";


    private static final Type TYPE = Type.POISON;
    private static final Effect EFFECT = Effect.POISON;
