...
public class Leer extends Move {
    ...
    private static final String NAME = "Leer";
    ...
    private static final String DESCRIPTION = "The user gives opposing Pokémon an intimidating leer that lowers the Defense stat.";


    private static final Type TYPE = Type.NORMAL;
    private static final Effect EFFECT = Effect.TARGET_DEF_DOWN;
