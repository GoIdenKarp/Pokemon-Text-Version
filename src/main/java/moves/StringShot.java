...
public class StringShot extends Move{
    ...
    private static final String NAME = "String Shot";
    private static final int STARTING_MAX_PP = 40;
    private static final int FINAL_MAX_PP = 64;
    private static final Boolean MAKES_CONTACT = false;
    private static final String DESCRIPTION = "The foe is bound with strings shot from the mouth to reduce its Speed.";


    private static final Type TYPE = Type.BUG;
    private static final Effect EFFECT = Effect.TARGET_SPD_DOWN;
