...
public class ScaryFace extends Move {
    ...
    private static final String NAME = "Scary Face";
    ...
    private static final String DESCRIPTION = "The user frightens the foe with a scary face to sharply reduce its" +
            " Speed stat.";


    private static final Type TYPE = Type.NORMAL;
    private static final Effect EFFECT = Effect.TARGET_SPD_DOWN_SHARP;
