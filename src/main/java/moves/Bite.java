...
public class Bite extends Move {
    ...
    private static final String DESCRIPTION = "The user bites with vicious fangs. It may make the foe flinch.";


    private static final Type TYPE = Type.DARK;
    private static final Effect EFFECT = Effect.FLINCH_TEN;
