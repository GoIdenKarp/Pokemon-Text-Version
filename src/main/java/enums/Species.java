...
public enum Species {
    ...
    PIDGEY, PIDGEOTTO, PIDGEOT, RATTATA, RATICATE, CATERPIE, METAPOD, BUTTERFREE, WEEDLE, KAKUNA, BEEDRILL, NIDORANF, NIDORINA,
    NIDOQUEEN, NIDORANM, NIDORINO, NIDOKING, SPEAROW, FEAROW, EKANS, ARBOK, SANDSHREW, SANDSLASH, VULPIX, NINETALES, MANKEY, PRIMEAPE;
