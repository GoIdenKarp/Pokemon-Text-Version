 ...
 */
public enum Species {
    BULBASAUR, IVYSAUR, VENUSAUR, CHARMANDER, CHARMELEON, CHARIZARD,SQUIRTLE, WARTORTLE, BLASTOISE, PIDGEY, 
    PIDGEOTTO, PIDGEOT, RATTATA, RATICATE, CATERPIE, METAPOD, BUTTERFREE, WEEDLE, KAKUNA, BEEDRILL, SPEAROW, 
    FEAROW, EKANS, ARBOK, PIKACHU, RAICHU, SANDSHREW, SANDSLASH, NIDORANF, NIDORINA, NIDOQUEEN, NIDORANM, NIDORINO,
    NIDOKING, VULPIX, NINETALES, MANKEY, PRIMEAPE,;
