...
public class FocusEnergy extends Move {
    ...
    private static final String NAME = "Focus Energy";
    ...
    private static final String DESCRIPTION = "The user takes a deep breath and focuses so that critical hits land more easily.";


    private static final Type TYPE = Type.NORMAL;
    private static final Effect EFFECT = Effect.FOCUS_ENERGY;
