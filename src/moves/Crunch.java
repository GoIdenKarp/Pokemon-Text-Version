...
public class Crunch extends Move {
    ...
    public static final String DESCRIPTION = "The foe is crunched with sharp fangs. It may lower the foe's Defense.";


    private static final Type TYPE = Type.DARK;
    private static final Effect EFFECT = Effect.DEF_DOWN_TWETNY;
