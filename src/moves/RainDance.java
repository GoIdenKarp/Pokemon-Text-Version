...
public class RainDance extends Move {
    ...
    private static final String NAME = "Rain Dance";
    ...
    private static final String DESCRIPTION = "The user summons a heavy rain that falls for five turns, " +
            "powering up Water-type moves. It lowers the power of Fire-type moves.";


    private static final Type TYPE = Type.WATER;
    private static final Effect EFFECT = Effect.RAIN;
