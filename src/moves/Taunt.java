...
public class Taunt extends Move {
    ...
    private static final String DESCRIPTION = "The target is taunted into a rage that allows it to use only attack moves" +
            " for three turns.";


    private static final Type TYPE = Type.DARK;
    private static final Effect EFFECT = Effect.TAUNT;
