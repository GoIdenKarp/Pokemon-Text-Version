...
public class Outrage extends MultiTurnMove {
    ...
    private static final String DESCRIPTION = "The user rampages and attacks for two to three turns. " +
