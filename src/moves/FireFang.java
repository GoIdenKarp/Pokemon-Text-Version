...
public class FireFang  extends Move {
    ...
    private static final String NAME = "Fire Fang";
    ...
    private static final String DESCRIPTION = "The user bites with flame-cloaked fangs. It may also make the foe flinch or sustain a burn.";


    private static final Type TYPE = Type.FIRE;
    private static final Effect EFFECT = Effect.BURN_TEN_FLINCH;
