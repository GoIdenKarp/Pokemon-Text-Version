...
public class Earthquake extends Move {
    ...
    private static final String NAME = "Earthquake";
    ...
    public static final String DESCRIPTION = "The user sets off an earthquake that strikes every Pokémon around it.";
