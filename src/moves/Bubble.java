...
public class Bubble extends Move {
    ...
    private static final String DESCRIPTION = "A spray of bubbles hits the foe. It may lower the foe's Speed stat.";


    private static final Type TYPE = Type.WATER;
    private static final Effect EFFECT = Effect.SPD_DOWN_TEN;
