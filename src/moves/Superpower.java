...
public class Superpower extends Move {
    ...
    private static final String NAME = "Superpower";
    ...
    private static final String DESCRIPTION = "The user attacks the target with great power. " +
            "However, this also lowers the user's Attack and Defense stats.";


    private static final Type TYPE = Type.FIGHTING;
    private static final Effect EFFECT = Effect.SELF_ATK_DEF_DOWN;
