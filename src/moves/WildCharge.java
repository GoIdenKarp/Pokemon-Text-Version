...
public class WildCharge extends Move {
    ...
    private static final String NAME = "Wild Charge";
    ...
    private static final String DESCRIPTION = "The user shrouds itself in electricity and smashes into its target. " +
            "This also damages the user a little.";


    private static final Type TYPE = Type.ELECTRIC;
    private static final Effect EFFECT = Effect.QUARTER_RECOIL;
