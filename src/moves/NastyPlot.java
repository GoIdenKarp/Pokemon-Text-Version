...
public class NastyPlot extends Move {
    ...
    private static final String NAME = "Nasty Plot";
    ...
    private static final String DESCRIPTION = "The user stimulates its brain by thinking bad thoughts. " +
            "This sharply raises the user's Sp. Atk stat.";


    private static final Type TYPE = Type.DARK;
    private static final Effect EFFECT = Effect.SELF_SPATK_UP_SHARP;
