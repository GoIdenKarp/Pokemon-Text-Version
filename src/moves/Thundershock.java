...
public class Thundershock extends Move {
    ...
    private static final String NAME = "Thundershock";
    ...
    private static final String DESCRIPTION = "A jolt of electricity is hurled at the foe to inflict damage. " +
            "It may also leave the foe paralyzed.";


    private static final Type TYPE = Type.ELECTRIC;
    private static final Effect EFFECT = Effect.PARATEN;
