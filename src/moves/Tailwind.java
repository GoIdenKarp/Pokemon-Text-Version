...
public class Tailwind extends Move {
    ...
    private static final String NAME = "Tailwind";
    ...
    private static final String DESCRIPTION = "The user whips up a turbulent whirlwind that ups the Speed stat of the " +
            "user and its allies for four turns.";


    private static final Type TYPE = Type.FLYING;
    private static final Effect EFFECT = Effect.TAILWIND;
