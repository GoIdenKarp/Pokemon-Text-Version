...
public class Protect extends Move {
    ...
    private static final String NAME = "Protect";
    ...
    private static final String DESCRIPTION = "Enables the user to evade all attacks. It may fail if used in succession.";


    private static final Type TYPE = Type.NORMAL;
    private static final Effect EFFECT = Effect.PROTECT;
