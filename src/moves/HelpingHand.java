...
public class HelpingHand extends Move {
    ...
    private static final String DESCRIPTION = "The user assists an ally by boosting the power of that ally's attack.";


    private static final Type TYPE = Type.NORMAL;
    private static final Effect EFFECT = Effect.HELPING_HAND;
    private static final Category CATEGORY = Category.STATUS;
    private static final Target TARGET = Target.ALLY;
