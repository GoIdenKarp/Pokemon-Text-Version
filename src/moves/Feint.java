...
public class Feint extends Move {
    ...
    private static final String NAME = "Feint";
    ...
    private static final String DESCRIPTION = "This attack hits a target using a move such as Protect or Detect. " +
            "This also lifts the effects of those moves.";


    private static final Type TYPE = Type.NORMAL;
    private static final Effect EFFECT = Effect.LIFT_PROTECT;
