...
public class Screech extends Move {
    ...
    private static final String NAME = "Screech";
    ...
    private static final String DESCRIPTION = "An earsplitting screech harshly lowers the target's Defense stat.";


    private static final Type TYPE = Type.NORMAL;
    private static final Effect EFFECT = Effect.TARGET_DEF_DOWN_SHARP;
