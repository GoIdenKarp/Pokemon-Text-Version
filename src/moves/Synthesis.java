...
public class Synthesis extends Move {
    ...
    private static final String NAME = "Synthesis";
    ...
    private static final String DESCRIPTION = "The user restores its own HP. The amount of HP regained varies with the weather.";


    private static final Type TYPE = Type.GRASS;
    private static final Effect EFFECT = Effect.RESTORE_SUN;
