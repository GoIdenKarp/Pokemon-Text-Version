...
public class DoubleTeam extends Move {
    ...
    private static final String NAME = "Double Team";
    ...
    private static final String DESCRIPTION = "By moving rapidly, the user makes illusory copies of itself to raise its evasiveness.";


    private static final Type TYPE = Type.NORMAL;
    private static final Effect EFFECT = Effect.SELF_EVADE_UP;
