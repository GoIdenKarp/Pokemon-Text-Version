...
public class HornAttack extends Move {
    ...
    private static final String NAME = "Horn Attack";
    ...
    private static final String DESCRIPTION = "The target is jabbed with a sharply pointed horn to inflict damage.";
