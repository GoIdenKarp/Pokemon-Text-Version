...
public class SweetScent extends Move {
    ...
    private static final String NAME = "Sweet Scent";
    ...
    private static final String DESCRIPTION = "A sweet scent that harshly lowers opposing Pokémon's evasiveness.";


    private static final Type TYPE = Type.NORMAL;
    private static final Effect EFFECT = Effect.TARGET_EVADE_DOWN_SHARP;
