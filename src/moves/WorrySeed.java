...
public class WorrySeed extends Move {
    ...
    private static final String DESCRIPTION = "A seed that causes worry is planted on the target. " +
            "It prevents sleep by making the target's Ability Insomnia.";


    private static final Type TYPE = Type.GRASS;
    private static final Effect EFFECT = Effect.WORRY_SEED;
