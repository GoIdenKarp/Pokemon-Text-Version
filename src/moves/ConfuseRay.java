...
public class ConfuseRay extends Move {
    ...
    private static final String NAME = "Confuse Ray";
    ...
    private static final String DESCRIPTION = "The target is exposed to a sinister ray that triggers confusion.";


    private static final Type TYPE = Type.GHOST;
    private static final Effect EFFECT = Effect.CONFUSE;
