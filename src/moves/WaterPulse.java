...
public class WaterPulse extends Move {
    ...
    private static final String NAME = "Water Pulse";
    ...
    private static final String DESCRIPTION = "The user attacks the target with a pulsing blast of water. " +
            "This may also confuse the target.";


    private static final Type TYPE = Type.WATER;
    private static final Effect EFFECT = Effect.CONFUSE_TWENTY;
