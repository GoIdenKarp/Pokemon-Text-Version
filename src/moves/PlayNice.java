...
public class PlayNice extends Move {
    ...
    private static final String DESCRIPTION = "The user and the target become friends, and the target loses its will to " +
            "fight. This lowers the target's Attack stat.";


    private static final Type TYPE = Type.NORMAL;
    private static final Effect EFFECT = Effect.TARGET_ATK_DOWN;
