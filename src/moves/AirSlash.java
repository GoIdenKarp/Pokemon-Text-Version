...
public class AirSlash  extends Move {
    ...
    private static final String DESCRIPTION = "The user attacks with a blade of air that slices even the sky. " +
            "This may also make the target flinch.";


    private static final Type TYPE = Type.FLYING;
    private static final Effect EFFECT = Effect.FLINCH_THIRTY;
