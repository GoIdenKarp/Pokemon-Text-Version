...
public class HydroPump extends Move {
    ...
    private static final String NAME = "Hydro Pump";
    ...
    private static final String DESCRIPTION = "The target is blasted by a huge volume of water launched under great pressure.";
