...
public class FellStinger extends Move {

    //Uses Gen VI power and effect
    private static final int BASE_POWER = 50;
    private static final int ACCURACY = 100;
    private static final int PRIORITY = 0;
    private static final int CRIT_STAGE = 0;
    private static final String NAME = "Fell Stinger";
    private static final int STARTING_MAX_PP = 25;
    private static final int FINAL_MAX_PP = 40;
    private static final Boolean MAKES_CONTACT = true;
    private static final String DESCRIPTION = "When the user knocks out a target with this move, the user's Attack stat rises drastically.";


    private static final Type TYPE = Type.BUG;
    private static final Effect EFFECT = Effect.FELL_STINGER;
