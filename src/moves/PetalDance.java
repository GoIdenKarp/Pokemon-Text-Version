...
public class PetalDance extends MultiTurnMove {

    //Uses Gen V power and PP
    private static final int BASE_POWER = 120;
    private static final int ACCURACY = 100;
    private static final int PRIORITY = 0;
    private static final int CRIT_STAGE = 0;
    private static final String NAME = "Petal Dance";
    ...
    private static final String DESCRIPTION = "The user attacks with petals for two to three turns, then gets confused.";
