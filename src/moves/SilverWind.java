...
public class SilverWind extends Move {
    ...
    private static final String NAME = "Silver Wind";
    ...
    private static final String DESCRIPTION = "The foe is attacked with a silver dust. It may raise all the user's stats.";


    private static final Type TYPE = Type.BUG;
    private static final Effect EFFECT = Effect.RAISE_ALL_TEN;
