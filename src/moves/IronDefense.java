...
public class IronDefense extends Move {
    ...
    private static final String NAME = "Iron Defense";
    ...
    private static final String DESCRIPTION = "The user hardens its body's surface like iron, sharply raising its Defense stat.";


    private static final Type TYPE = Type.STEEL;
    private static final Effect EFFECT = Effect.SELF_DEF_UP_SHARP;
