...
public class Acid extends Move {
    ...
    private static final String DESCRIPTION = "The opposing Pokémon are attacked with a spray of harsh acid. " +
            "This may also lower their Sp. Def stat.";


    private static final Type TYPE = Type.POISON;
    private static final Effect EFFECT = Effect.SPDEF_DOWN_TEN;
