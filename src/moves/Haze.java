...
public class Haze extends Move {
    ...
    private static final String NAME = "Haze";
    ...
    private static final String DESCRIPTION = "The user creates a haze that eliminates every stat change among all the Pokémon engaged in battle.";


    private static final Type TYPE = Type.ICE;
    private static final Effect EFFECT = Effect.HAZE;
