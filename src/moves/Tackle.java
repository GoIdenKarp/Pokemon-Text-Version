...
public class Tackle extends Move {
    ...
    private static final String DESCRIPTION = "A physical attack in which the user charges, full body, into the foe.";
