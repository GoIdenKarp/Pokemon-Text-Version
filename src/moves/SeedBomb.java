...
public class SeedBomb extends Move {
    ...
    private static final String NAME = "Seed Bomb";
    ...
    private static final String DESCRIPTION = "The user slams a barrage of hard-shelled seeds down on the target from above.";
