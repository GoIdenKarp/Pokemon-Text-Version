...
public class SolarBeam extends ChargeMove {

    private static final String CHARGE_MESSAGE = "%s took in sunlight!\n";
    ...
    private static final String DESCRIPTION = "A two-turn attack. The user gathers light, then blasts a bundled beam on the next turn.";
