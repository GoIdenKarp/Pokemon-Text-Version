...
public class Hurricane extends Move {
    ...
    private static final String NAME = "Hurricane";
    ...
    private static final String DESCRIPTION = "A vicious twister attacks the foe. It may make the foe flinch.";


    private static final Type TYPE = Type.FLYING;
    private static final Effect EFFECT = Effect.CONFUSE_THIRTY;
