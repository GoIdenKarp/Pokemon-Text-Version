...
public class MirrorMove extends Move {
    ...
    private static final String NAME = "Mirror Move";
    ...
    private static final String DESCRIPTION = "The user counters the target by mimicking the target's last move.\n";


    private static final Type TYPE = Type.FLYING;
    private static final Effect EFFECT = Effect.MIRROR_MOVE;
